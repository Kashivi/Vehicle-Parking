<template>
  <div class="user-dashboard">
    <nav class="navbar mb-4">
      ...
      <router-link to="/edit-profile" class="ms-auto btn btn-outline-primary">Edit Profile</router-link>
    </nav>
    <router-view/>
...
export default {
  ...
  methods: {
    ...
    resp = await axios.get('/api/parkinglot/pincode', {
      params: { pincode: this.query },
      ...config
    });
  }
...
bookLot(lotId) {
  this.$router.push({ name: 'SpotRegister', params: { lotId } });
}
  }
};
</script>
